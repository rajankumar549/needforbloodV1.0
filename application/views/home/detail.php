    <section style="background: #fafafa;">
      <div class="container">
        ...
        <h1 class="heading">Webdesigner<br><small>at <a href="#">Google</a></small></h1>
        <div class="job-detail-description"><i class="fa fa-map-marker job__location"> </i>Palo Alto
          | Posted 10 days ago |<span class="label featured__label label-success">Full Time</span>
        </div>
      </div>
    </section>
    <section>
      <div class="container">
        <div class="row">
          <div class="col-lg-8">
            ...
            <div class="job-detail__apply-bottom"><a href="#" class="btn btn-primary">Apply for this job</a></div>
          </div>
          <div class="col-lg-3 col-lg-offset-1">
            ...
            <div class="job-detail__apply-top"><a href="#" class="btn btn-primary">Apply for this job</a></div>
          </div>
        </div>
      </div>
    </section>
