<head>
<script type= "text/javascript"  href="<?php echo base_url();?>view/countries.js">
  populateCountries("country", "state-register");
</script>
</head>
...
<form id="job-main-form-donor-register" method="post" action="<?php echo base_url(); ?>admin/ajaxfunction/savedonor" class="job-main-form">
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="form-group">
                        ...
                        <select id="country" name="country" required="required" placeholder="Choose country" class="form-control" type="text">
...
<div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <select id="state-register"  required="required" onchange="fetchdistrict(this.value)" name="state" placeholder="Any particular location?" class="form-control" type="text">
...
<div class="row">
                    <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <select id="district-register" required="required" name="district" placeholder="choose district" class="form-control" onchange="fetchcity(this.value)" type="text">
  ...
  <div class="col-sm-4">
                      <div class="form-group">
                        ...
                        <input id="phone" name="mobile_number" required="required" placeholder="Your Emergency Number" class="form-control" type="number">
                      </div>
                    </div>
                    </div>
<div class="row">
...
<option value="O-">O-</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select id="location" name="location" placeholder="Any particular location?" class="form-control" type="text">
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select id="profession" name="profession" placeholder="Profession you are looking for" class="form-control" type="text" onchange="getdistrict(this.value)">
...
<option value="0">Select State</option>
                    ...
                    <div class="col-sm-6">
                      <div class="form-group">
                        ...
                        <select id="district" onchange="getCity(this.value)" name="location" placeholder="Any particular location?" class="form-control" type="text">
