    ...
    <center style="width: 100%;">
        ...
        <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="600" style="margin: auto;" class="email-container">
          ...
          <!--  <tr>
            ...
            <!-- 1 Column Text : BEGIN -->
            <tbody><tr>
                <td bgcolor="#32a0ff" style="padding: 10px 40px 10px 40px;font-family: sans-serif;font-size: 15px;line-height: 20px;color: #ffffff;">
                   <p>Hello <?php echo $name;?></p>
                   
<p style="
    margin-top: -1%;color:white;
">Welcome to OlympiadBox.Your account has been succesfully created.You can start taking the demo.</p><p style="
    margin-top: -1%;
">Account Details are:</p>

<div style="
    margin-top: -4%;
">
<p style="
    margin-top: 4% ;color:white;
"><span>Username</span>:<?php echo $email;?></p>
<p style="
    margin-top: -3%;
"><span>Password</span>:<?php echo $password;?></p>
</div>
